...
require("../pgadmin2/globals.php");
  ...
  if ($Action == "Add") {
    ...
    pg_exec($db, "INSERT INTO downloads(id, site, filename, product, version, description, details, active) VALUES ('". pg_result($rs, 0, "id") . "', '".$site."', '".$filename."', '".$product."', '".$version."', '".$description."', '".$details."', '$active')");
