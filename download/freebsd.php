...
$PAGE_TITLE = _("pgAdmin: Download - FreeBSD");
$PAGE_CONTENT = '
...
<p>' . _("pgAdmin packages are available for download. These packages have been built on FreeBSD 6.") . '</p>
<ul>
  <li>' . sprintf(_("<a href=\"%s\">pgAdmin v%s</a>"), "http://www.postgresql.org/ftp/pgadmin3/release/v1.8.2/freebsd62", "1.8.2") . '<br />&nbsp;</li>
  <li>' . sprintf(_("<a href=\"%s\">pgAdmin v%s</a>"), "http://www.postgresql.org/ftp/pgadmin3/release/v1.8.1/freebsd62", "1.8.1") . '<br />&nbsp;</li>
...
<p>' . _("Create a symlink to the pgAdmin binary:") . '</p>

<div class="pgaCode">
# ln -sf /usr/local/pgadmin3/bin/pgadmin3 /usr/local/bin/pgadmin3
</div><br />&nbsp;

<p>' . _("Check that the pgAdmin executable is in the path:") . '</p>
