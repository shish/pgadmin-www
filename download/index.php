...
<p>' . sprintf(_("pgAdmin III is a free software project released under the <a href=\"%s\">BSD/Artistic licence</a>. The software is available in source and binary format from the <a href=\"%s\">PostgreSQL mirror network</a>. Because compiling from source requires technical knowledge, we recommend installing binary packages whenever possible."), "../licence.php", "http://www.postgresql.org/ftp/pgadmin3/release/") . '</p>
