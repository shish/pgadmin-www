...
<p>' . _("The pages in this section give additional details about each binary package available as well as more direct download links. In addition, you can download source tarballs, additional language translations and admin packs for you servers to enable additional functionality.") . '</p>
'; 
