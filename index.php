...
<p>' . _("pgAdmin 1.14 beta 1 has been released, offering lots of new interesting features. We're still working on a visual tour. In the mean time, the list of new features fixes is available in the <a href=\"/development/changelog.php\">CHANGELOG</a>. Please visit the <a href=\"download\">download area</a> to get your copy, or alternatively download a <a href=\"http://www.enterprisedb.com/products/pgdownload.do\">PostgreSQL 9.1 beta 1 Installer</a> which includes pgAdmin.") . '</p>
