...
<dl>
  ...
  <dd>
  Promotion is essential in the life and development of the pgAdmin project. Reaching new users can help pgAdmin project get in touch with talented developers, who may in turn bring exciting new features to pgAdmin and possibly to PostgreSQL too.
  </dd>
  ...
  <dd>
        ...
        <ul>
          ...
          <li>pgAdmin web site si not (yet) intelligent enough to guess the default language of your browser. Therefore, the default language is English. For registration in your language, use the address of pgAdmin website returned after clicking on your country flag. For example, French homepage is <a href='http://www.pgadmin.org/pgadmin3/index.php?locale=fr_FR'>http://www.pgadmin.org/pgadmin3/index.php?locale=fr_FR</a>.
