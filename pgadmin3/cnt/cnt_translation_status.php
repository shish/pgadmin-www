...
//
  ...
  $translated->addLanguage ("ar_SA", "Arabic", "Ossama Khayat", "okhayat@yahoo.com", "pgadmin3.po","src/ui/ar_SA/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  $outofdate->addLanguage ("bg_BG", "Bulgarian", "Latchezar Kostov", "lkostov_hobby@yahoo.co.uk", "pgadmin3.po","src/ui/bg_BG/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  ...
  $outofdate->addLanguage ("gl_ES", "Galician", "Antonio Ricoy", "aricoy@edu.xunta.es", "pgadmin3.po","src/ui/gl_ES/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  $outofdate->addLanguage ("hr_HR", "Croatian", "Finteh d.o.o.", "finteh@finteh.hr", "pgadmin3.po", "src/ui/hr_HR/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  ...
  $outofdate->addLanguage ("pt_BR", "Portuguese-Brazilian", "Ângelo Marcos Rigo", "angelo_rigo@yahoo.com.br", "pgadmin3.po","src/ui/pt_BR/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  ...
  $outofdate->addLanguage ("ro_RO", "Romanian", "Nagy Karoly", "nagykaroly@expert-software.ro", "pgadmin3.po", "src/ui/ro_RO/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  ...
  $outofdate->addLanguage ("sv_SE", "Swedish", "Unmaintained", "pgadmin-hackers@postgresql.org", "pgadmin3.po","src/ui/sv_SE/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  $outofdate->addLanguage ("te_IN", "Telugu", "Sai Suresh Danduboyina", "saisuresh@cc.usu.edu", "pgadmin3.po","src/ui/te_IN/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  $outofdate->addLanguage ("tl_PH", "Filipino/Tagalog", "Howard Bagcat", "howard@mu.edu.ph", "pgadmin3.po","src/ui/tl_PH/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  ...
  $outofdate->addLanguage ("ur_PK", "Urdu", "Zaeem Arshad", "zaeem.arshad@gmail.com", "pgadmin3.po","src/ui/ur_PK/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
  ...
  $translated->addLanguage ("zh_TW", "Chinese traditional", "Unmaintained", "pgadmin-hackers@postgresql.org", "pgadmin3.po", "src/ui/zh_TW/pgadmin3.po", "pgadmin3.pot", "pgadmin3.pot");
