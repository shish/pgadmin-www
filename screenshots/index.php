...
<p>' . _("We provide source and binary packages for Linux, FreeBSD, Mac OSX and Microsoft Windows &trade;. Solaris binaries may also be compiled from the source code.") . '</p>
