...
<p>' . sprintf(_("Messages sent to the list are archived at <a href=\"%s\">PostgreSQL</a> and  <a href=\"%s\">mail-archive.com</a>."), "http://archives.postgresql.org/pgadmin-support/", "http://www.mail-archive.com/pgadmin-support@postgresql.org") . '</p>
